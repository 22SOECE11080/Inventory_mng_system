                ...
                <div class="container-fluid pt-4">
                    <div class="bg-light text-center rounded p-4">
                        ...
                        if(isset($_POST['update'])){
                            ...
                            //update query
                            $update = "UPDATE contact SET icons='$icons', title='$title', content='$content' WHERE id='$contact_id' ";
                        ...
                        //to fetch the data
                        $cont_id = $_GET['c_id'];
                        $sql_select = "SELECT * FROM contact WHERE id='$cont_id' ";
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="icons" name="icons" value="<?php echo $row['icons']; ?>">
                            </div>
                            <div class="form-group">
